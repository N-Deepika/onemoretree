    ...
    <div className="dark:bg-gray-200">
      <div className="container mx-auto py-9 md:py-12 lg:py-24">
        <div className="relative mx-4">
          ...
          <div className="absolute top-0 left-0 mx-4 sm:mx-0 mt-36 sm:mt-0 sm:py-20 md:py-28 lg:py-20 xl:py-28 sm:pl-14 flex flex-col sm:justify-start items-start">
